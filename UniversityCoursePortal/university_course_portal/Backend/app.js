...
// ADMIN--DEPT
app.post("/add/dept", async function(req, res) {
    console.log(req.body);
    var{Dept_id,Dept_name,HOD,Dept_capacity}=req.body;


   await sqlConnection.query("INSERT into department set ?", {Dept_id,Dept_name,HOD,Dept_capacity}, async function(err, results) {
        if (err) {
            console.log(err);
        } else {
            try {
                sqlConnection.query('select * from department', function (error, results, fields) {
                    if (error) throw error;
                    console.log(results);
                    var a="Department Added Successfully"
                    res.render("send.ejs",{a})
                  }) 
            } catch (error) {
                console.log(error);
...
app.post("/remove/dept", async function(req, res) {
    console.log(req.body);
    var{Dept_id}=req.body;


   await sqlConnection.query(`Delete from course where Dept_id='${Dept_id}'`, async function(err, results) {
        sqlConnection.query(`Delete from Faculty where Dept_id='${Dept_id}'`,async function(err, results1){
            sqlConnection.query(`Delete from Student where Dept_id='${Dept_id}'`,async function(err, results2){
                sqlConnection.query(`Delete from Announcement where Dept_id='${Dept_id}'`,async function(err, results3){
                    sqlConnection.query(`Delete from Department where Dept_id='${Dept_id}'`,async function(err, results4){
                        var a="Department Deleted Successfully"
                        res.render("send.ejs",{a})                    })
                })
            })
        })
...
app.get('/RemDept', function(req, res){
    try {
...
app.post('/Rem_enroll/course',async function(req,res){
    ...
    await sqlConnection.query(`Delete from enrolls where Roll_no="${Roll_no}" and Course_id="${Course_id}"` ,async function(err, results) {
        var a="Course Removed Successfully"
        res.render("send.ejs",{a})    
    })
})
...
app.post('/add/mark',async function(req,res){
    ...
    sqlConnection.query(`Insert into Attends values('${Roll_no}','${Course_id}','${Test_name}','${mark_obt}')`,function(err,results,fields){
        res.send("Mark Added")
    })
})
...
app.post('/add/announcement',async function(req,res){
    ...
    sqlConnection.query(`UPDATE course set Announcements="${Announcement}" where Course_id="${Course_id}"`,function(err,results,fields){
        res.send("Announcement has been made")
    })
})
//STUD-SIDE
...
app.post("/add/feedback",  function(req, res) {
    console.log(req.body);
    var {submit,username,feedback,faculty_id}=req.body;
    let Roll_no = username;
    console.log(Roll_no);
    var comments=feedback;
    var Faculty_id=faculty_id;
    
    sqlConnection.query("INSERT into feedback set ?", { Roll_no, comments,Faculty_id}, async function(err, results) {
        if (err) {
            console.log(err);
        } else {
            try {
...
// STUD COURSES
app.get('/AEE101',async function(req,res){
    var val="AEE101";
    console.log(`select Faculty_id from teaches where Course_id="${val}"`)
    sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results,fields){
...
app.get('/AEE203',async function(req,res){
    var val="AEE203";
    console.log(`select Faculty_id from teaches where Course_id="${val}"`)
    sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results,fields){
...
app.get('/AEE302',async function(req,res){
    var val="AEE302";
    console.log(`select Faculty_id from teaches where Course_id="${val}"`)
    sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results,fields){
...
app.get('/AEE312',async function(req,res){
    var val="AEE312";
    console.log(`select Faculty_id from teaches where Course_id="${val}"`)
    sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results,fields){
...
app.get('/CHE101',async function(req,res){
    var val="CHE101";
    console.log(`select Faculty_id from teaches where Course_id="${val}"`)
    sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results,fields){
...
app.get('/CHE204',async function(req,res){
    var val="CHE204";
    console.log(`select Faculty_id from teaches where Course_id="${val}"`)
    sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results,fields){
...
app.get('/CHE212',async function(req,res){
    var val="CHE212";
    console.log(`select Faculty_id from teaches where Course_id="${val}"`)
    sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results,fields){
...
app.get('/CHE313',async function(req,res){
    var val="CHE313";
    console.log(`select Faculty_id from teaches where Course_id="${val}"`)
    sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results,fields){
...
app.get('/CIV101',async function(req,res){
    var val="CIV101";
    console.log(`select Faculty_id from teaches where Course_id="${val}"`)
    sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results,fields){
...
app.get('/CIV203',async function(req,res){
    var val="CIV203";
    console.log(`select Faculty_id from teaches where Course_id="${val}"`)
    sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results,fields){
...
app.get('/CIV211',async function(req,res){
    var val="CIV211";
    console.log(`select Faculty_id from teaches where Course_id="${val}"`)
    sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results,fields){
...
app.get('/CIV312',async function(req,res){
    var val="CIV312";
    console.log(`select Faculty_id from teaches where Course_id="${val}"`)
    sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results,fields){
...
app.get('/CSE101',async function(req,res){
    var val="CSE101";
    console.log(`select Faculty_id from teaches where Course_id="${val}"`)
    sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results,fields){
...
app.get('/CSE212',async function(req,res){
    var val="CSE212";
    console.log(`select Faculty_id from teaches where Course_id="${val}"`)
    sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results,fields){
...
app.get('/CSE302',async function(req,res){
    var val="CSE302";
    console.log(`select Faculty_id from teaches where Course_id="${val}"`)
    sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results,fields){
...
app.get('/CSE303',async function(req,res){
    var val="CSE303";
    console.log(`select Faculty_id from teaches where Course_id="${val}"`)
    sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results,fields){
...
app.get('/ECE201',async function(req,res){
    var val="ECE201";
    console.log(`select Faculty_id from teaches where Course_id="${val}"`)
    sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results,fields){
...
app.get('/ECE202',async function(req,res){
    var val="ECE202";
    console.log(`select Faculty_id from teaches where Course_id="${val}"`)
    sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results,fields){
...
app.get('/ECE203',async function(req,res){
    var val="ECE203";
    console.log(`select Faculty_id from teaches where Course_id="${val}"`)
    sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results,fields){
...
app.get('/ECE303',async function(req,res){
    var val="ECE303";
    console.log(`select Faculty_id from teaches where Course_id="${val}"`)
    sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results,fields){
...
app.get('/EEE111',async function(req,res){
    var val="EEE111";
    console.log(`select Faculty_id from teaches where Course_id="${val}"`)
    sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results,fields){
...
app.get('/EEE204',async function(req,res){
    var val="EEE204";
    console.log(`select Faculty_id from teaches where Course_id="${val}"`)
    sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results,fields){
...
app.get('/EEE212',async function(req,res){
    var val="EEE212";
    console.log(`select Faculty_id from teaches where Course_id="${val}"`)
    sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results,fields){
...
app.get('/EIE219',async function(req,res){
    var val="EIE219";
    console.log(`select Faculty_id from teaches where Course_id="${val}"`)
    sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results,fields){
...
app.get('/EIE312',async function(req,res){
    var val="EIE312";
    console.log(`select Faculty_id from teaches where Course_id="${val}"`)
    sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results,fields){
...
app.get('/MAT101',async function(req,res){
    var val="MAT101";
    console.log(`select Faculty_id from teaches where Course_id="${val}"`)
    sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results,fields){
...
app.get('/MAT202',async function(req,res){
    var val="MAT202";
    console.log(`select Faculty_id from teaches where Course_id="${val}"`)
    sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results,fields){
...
app.get('/MAT305',async function(req,res){
    var val="MAT305";
    console.log(`select Faculty_id from teaches where Course_id="${val}"`)
    sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results,fields){
...
app.get('/MEE101',async function(req,res){
    var val="MEE101";
    console.log(`select Faculty_id from teaches where Course_id="${val}"`)
    sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results,fields){
...
app.get('/MEE206',async function(req,res){
    var val="MEE206";
    console.log(`select Faculty_id from teaches where Course_id="${val}"`)
    sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results,fields){
...
app.get('/MEE302',async function(req,res){
    var val="MEE302";
    console.log(`select Faculty_id from teaches where Course_id="${val}"`)
    sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results,fields){
...
app.get('/PHY305',async function(req,res){
    var val="PHY305";
    console.log(`select Faculty_id from teaches where Course_id="${val}"`)
    sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results,fields){
...
// Faculty Courses
app.get('/AEE101-1',async function(req,res){
    var val="AEE101";
    sqlConnection.query(`select details from course where Course_id="${val}"`, function (error, results, fields) {
        sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results1,fields){
            ...
            console.log(b)
            sqlConnection.query(`select F_Fname,F_Lname from faculty where Faculty_id='${b}'`,function(error,results2,fields){
                res.render("faculty-details",{val,det:results[0],Facname:results2[0]});
...
app.get('/AEE203-1',async function(req,res){
    var val="AEE203";
    sqlConnection.query(`select details from course where Course_id="${val}"`, function (error, results, fields) {
        sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results1,fields){
            var b=results1[0].Faculty_id;
...
app.get('/AEE302-1',async function(req,res){
    var val="AEE302";
    sqlConnection.query(`select details from course where Course_id="${val}"`, function (error, results, fields) {
        sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results1,fields){
            var b=results1[0].Faculty_id;
...
app.get('/AEE312-1',async function(req,res){
    var val="AEE312";
    sqlConnection.query(`select details from course where Course_id="${val}"`, function (error, results, fields) {
        sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results1,fields){
            var b=results1[0].Faculty_id;
...
app.get('/CHE101-1',async function(req,res){
    var val="CHE101";
    sqlConnection.query(`select details from course where Course_id="${val}"`, function (error, results, fields) {
        sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results1,fields){
            var b=results1[0].Faculty_id;
...
app.get('/CHE204-1',async function(req,res){
    var val="CHE204";
    sqlConnection.query(`select details from course where Course_id="${val}"`, function (error, results, fields) {
        sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results1,fields){
            var b=results1[0].Faculty_id;
...
app.get('/CHE212-1',async function(req,res){
    var val="CHE212";
    sqlConnection.query(`select details from course where Course_id="${val}"`, function (error, results, fields) {
        sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results1,fields){
            var b=results1[0].Faculty_id;
...
app.get('/CHE313-1',async function(req,res){
    var val="CHE313";
    sqlConnection.query(`select details from course where Course_id="${val}"`, function (error, results, fields) {
        sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results1,fields){
            var b=results1[0].Faculty_id;
...
app.get('/CIV101-1',async function(req,res){
    var val="CIV101";
    sqlConnection.query(`select details from course where Course_id="${val}"`, function (error, results, fields) {
        sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results1,fields){
            var b=results1[0].Faculty_id;
...
app.get('/CIV203-1',async function(req,res){
    var val="CIV203";
    sqlConnection.query(`select details from course where Course_id="${val}"`, function (error, results, fields) {
        sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results1,fields){
            var b=results1[0].Faculty_id;
...
app.get('/CIV211-1',async function(req,res){
    var val="CIV211";
    sqlConnection.query(`select details from course where Course_id="${val}"`, function (error, results, fields) {
        sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results1,fields){
            var b=results1[0].Faculty_id;
...
app.get('/CIV312-1',async function(req,res){
    var val="CIV312";
    sqlConnection.query(`select details from course where Course_id="${val}"`, function (error, results, fields) {
        sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results1,fields){
            var b=results1[0].Faculty_id;
...
app.get('/CSE101-1',async function(req,res){
    var val="CSE101";
    sqlConnection.query(`select details from course where Course_id="${val}"`, function (error, results, fields) {
        sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results1,fields){
            var b=results1[0].Faculty_id;
...
app.get('/CSE212-1',async function(req,res){
    var val="CSE212";
    sqlConnection.query(`select details from course where Course_id="${val}"`, function (error, results, fields) {
        sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results1,fields){
            var b=results1[0].Faculty_id;
...
app.get('/CSE302-1',async function(req,res){
    var val="CSE302";
    sqlConnection.query(`select details from course where Course_id="${val}"`, function (error, results, fields) {
        sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results1,fields){
            var b=results1[0].Faculty_id;
...
app.get('/CSE303-1',async function(req,res){
    var val="CSE303";
    sqlConnection.query(`select details from course where Course_id="${val}"`, function (error, results, fields) {
        sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results1,fields){
            var b=results1[0].Faculty_id;
...
app.get('/ECE201-1',async function(req,res){
    var val="ECE201";
    sqlConnection.query(`select details from course where Course_id="${val}"`, function (error, results, fields) {
        sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results1,fields){
            var b=results1[0].Faculty_id;
...
app.get('/ECE202-1',async function(req,res){
    var val="ECE202";
    sqlConnection.query(`select details from course where Course_id="${val}"`, function (error, results, fields) {
        sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results1,fields){
            var b=results1[0].Faculty_id;
...
app.get('/ECE203-1',async function(req,res){
    var val="ECE203";
    sqlConnection.query(`select details from course where Course_id="${val}"`, function (error, results, fields) {
        sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results1,fields){
            var b=results1[0].Faculty_id;
...
app.get('/ECE303-1',async function(req,res){
    var val="ECE303";
    sqlConnection.query(`select details from course where Course_id="${val}"`, function (error, results, fields) {
        sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results1,fields){
            var b=results1[0].Faculty_id;
...
app.get('/EEE111-1',async function(req,res){
    var val="EEE111";
    sqlConnection.query(`select details from course where Course_id="${val}"`, function (error, results, fields) {
        sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results1,fields){
            var b=results1[0].Faculty_id;
...
app.get('/EEE204-1',async function(req,res){
    var val="EEE204";
    sqlConnection.query(`select details from course where Course_id="${val}"`, function (error, results, fields) {
        sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results1,fields){
            var b=results1[0].Faculty_id;
...
app.get('/EEE212-1',async function(req,res){
    var val="EEE212";
    sqlConnection.query(`select details from course where Course_id="${val}"`, function (error, results, fields) {
        sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results1,fields){
            var b=results1[0].Faculty_id;
...
app.get('/EIE219-1',async function(req,res){
    var val="EIE219";
    sqlConnection.query(`select details from course where Course_id="${val}"`, function (error, results, fields) {
        sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results1,fields){
            var b=results1[0].Faculty_id;
...
app.get('/EIE312-1',async function(req,res){
    var val="EIE312";
    sqlConnection.query(`select details from course where Course_id="${val}"`, function (error, results, fields) {
        sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results1,fields){
            var b=results1[0].Faculty_id;
...
app.get('/MAT101-1',async function(req,res){
    var val="MAT101";
    sqlConnection.query(`select details from course where Course_id="${val}"`, function (error, results, fields) {
        sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results1,fields){
            var b=results1[0].Faculty_id;
...
app.get('/MAT202-1',async function(req,res){
    var val="MAT202";
    sqlConnection.query(`select details from course where Course_id="${val}"`, function (error, results, fields) {
        sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results1,fields){
            var b=results1[0].Faculty_id;
...
app.get('/MAT305-1',async function(req,res){
    var val="MAT305";
    sqlConnection.query(`select details from course where Course_id="${val}"`, function (error, results, fields) {
        sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results1,fields){
            var b=results1[0].Faculty_id;
...
app.get('/MEE101-1',async function(req,res){
    var val="MEE101";
    sqlConnection.query(`select details from course where Course_id="${val}"`, function (error, results, fields) {
        sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results1,fields){
            var b=results1[0].Faculty_id;
...
app.get('/MEE206-1',async function(req,res){
    var val="MEE206";
    sqlConnection.query(`select details from course where Course_id="${val}"`, function (error, results, fields) {
        sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results1,fields){
            var b=results1[0].Faculty_id;
...
app.get('/MEE302-1',async function(req,res){
    var val="MEE302";
    sqlConnection.query(`select details from course where Course_id="${val}"`, function (error, results, fields) {
        sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results1,fields){
            var b=results1[0].Faculty_id;
...
app.get('/PHY305-1',async function(req,res){
    var val="PHY305";
    sqlConnection.query(`select details from course where Course_id="${val}"`, function (error, results, fields) {
        sqlConnection.query(`select Faculty_id from teaches where Course_id="${val}"`,function(error,results1,fields){
            var b=results1[0].Faculty_id;
...
//   app.get('/showdept', function(req, res){
//     try {
...
//             console.log("hi")
//             console.log(results);
//             res.render("Add_Dept",{departments:results});
//         })
//     } catch (error) {
//         console.log(error);
//     }
